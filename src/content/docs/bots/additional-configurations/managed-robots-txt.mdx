...
<Tabs syncKey="dashNewNav">
	<TabItem label="Old dashboard">
		<Steps>
			...
			select your account and domain. 2. Go to **Security** > **Bots**. 3.
			Select **Configure Bot Fight Mode**. 4. Turn **Instruct bot traffic with
			robots.txt** on.
		</Steps>
	</TabItem>
	<TabItem label="New dashboard" icon="rocket">
		<Steps>
			...
			2. Filter by **Bot traffic**. 3. Go to **robots.txt setting**. 4. Turn
			**robots.txt setting** on.
		</Steps>
	</TabItem>
</Tabs>
