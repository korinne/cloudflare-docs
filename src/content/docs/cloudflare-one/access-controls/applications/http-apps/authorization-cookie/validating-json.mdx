...
Add these [environment variables](/workers/configuration/environment-variables/) to your Worker: - `POLICY_AUD`: Your application's [AUD tag](#get-your-aud-tag) - `TEAM_DOMAIN`: `https://<your-team-name>.cloudflareaccess.com`, where `<your-team-name>` is replaced with your actual <GlossaryTooltip term="team name">team name</GlossaryTooltip>.
